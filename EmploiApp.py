...
"")
        ...
        self.ButtonEmpty = QtWidgets.QPushButton(self.frame)
        self.ButtonEmpty.setGeometry(QtCore.QRect(210, 240, 101, 31))
        self.ButtonEmpty.setStyleSheet("QPushButton{\n"
"   background-color: qlineargradient(spread:pad, x1:0, y1:0, x2:1, y2:0, stop:0 #71b7e6, stop:1 #9b60b6);\n"
"    \n"
"    border: none;\n"
"    border-radius:  10px;\n"
...
"        fichier et rempli le formulaire"))
        self.ButtonEmpty.setText(_translate("MainWindow", "Vider \n"
"le cache"))
